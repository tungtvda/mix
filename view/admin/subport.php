...
{
    return '<th>id</th><th>danhmuc_id</th><th>name</th><th>phone</th><th>phone_format</th><th>skype</th><th>email</th><th>yahoo</th>';
}
//
function showTableBody($data)
{
    ...
    if(count($data)>0) foreach($data as $obj)
    {
        ...
        $TableBody.="<td>".$obj->phone_format."</td>";
...
function showFrom($form,$ListKey=array())
{
    ...
    $str_from.='<p><label>phone_format</label><input class="text-input small-input" type="text"  name="phone_format" value="'.(($form!=false)?$form->phone_format:'').'" /></p>';
