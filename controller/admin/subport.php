...
if(isset($_SESSION["Admin"]))
{
    ...
    $data['listfkey']['danhmuc_id']=danhmuc_subport_getByAll();
    ...
    if(isset($_POST["danhmuc_id"])&&isset($_POST["name"])&&isset($_POST["phone"])&&isset($_POST["phone_format"])&&isset($_POST["skype"])&&isset($_POST["email"])&&isset($_POST["yahoo"]))
    {
       $array=$_POST;
       if(!isset($array['id']))
       $array['id']='0';
       ...
       $array['phone']='0';
       if(!isset($array['phone_format']))
       $array['phone_format']='0';
